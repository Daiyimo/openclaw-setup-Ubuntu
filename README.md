...
> Last updated: 2026-03-12 | Update by Claude-4.6-Sonnet
...
|------|-------------------|------|
| [2026.3.11](https://github.com/Daiyimo/openclaw-setup-Ubuntu/tree/2026.3.11) | v2026.3.11 | ✅ 最新 |
| [2026.3.8](https://github.com/Daiyimo/openclaw-setup-Ubuntu/tree/2026.3.8) | v2026.3.8 | 维护中 |
...
**或指定版本：**
```bash
OPENCLAW_VERSION=2026.3.11 curl -fsSL https://gh-proxy.com/https://raw.githubusercontent.com/Daiyimo/openclaw-setup-Ubuntu/main/scripts/setup.sh | bash
```
...
# 或指定版本
OPENCLAW_VERSION=2026.3.11 sudo bash scripts/update.sh
```
